...
PK_EXPORT PkHandle* pkExportModule(PKVM* vm) {
  ...
  cls_Vector2 = pkNewClass(vm, "Vector2", NULL, raylib, _Vector2New, _Vector2Delete, "Vector2, 2 components");
  pkClassAddMethod(vm, cls_Vector2, "@getter",  _Vector2Getter, 1, NULL);
  pkClassAddMethod(vm, cls_Vector2, "@setter",  _Vector2Setter, 2, NULL);

  cls_Vector3 = pkNewClass(vm, "Vector3", NULL, raylib, _Vector3New, _Vector3Delete, "Vector3, 3 components");
  pkClassAddMethod(vm, cls_Vector3, "@getter",  _Vector3Getter, 1, NULL);
  pkClassAddMethod(vm, cls_Vector3, "@setter",  _Vector3Setter, 2, NULL);

  cls_Vector4 = pkNewClass(vm, "Vector4", NULL, raylib, _Vector4New, _Vector4Delete, "Vector4, 4 components");
  pkClassAddMethod(vm, cls_Vector4, "@getter",  _Vector4Getter, 1, NULL);
  pkClassAddMethod(vm, cls_Vector4, "@setter",  _Vector4Setter, 2, NULL);

  cls_Matrix = pkNewClass(vm, "Matrix", NULL, raylib, _MatrixNew, _MatrixDelete, "Matrix, 4x4 components, column major, OpenGL style, right handed");
  pkClassAddMethod(vm, cls_Matrix, "@getter",  _MatrixGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Matrix, "@setter",  _MatrixSetter, 2, NULL);

  cls_Color = pkNewClass(vm, "Color", NULL, raylib, _ColorNew, _ColorDelete, "Color, 4 components, R8G8B8A8 (32bit)");
  pkClassAddMethod(vm, cls_Color, "@getter",  _ColorGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Color, "@setter",  _ColorSetter, 2, NULL);

  cls_Rectangle = pkNewClass(vm, "Rectangle", NULL, raylib, _RectangleNew, _RectangleDelete, "Rectangle, 4 components");
  pkClassAddMethod(vm, cls_Rectangle, "@getter",  _RectangleGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Rectangle, "@setter",  _RectangleSetter, 2, NULL);

  cls_Image = pkNewClass(vm, "Image", NULL, raylib, _ImageNew, _ImageDelete, "Image, pixel data stored in CPU memory (RAM)");
  pkClassAddMethod(vm, cls_Image, "@getter",  _ImageGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Image, "@setter",  _ImageSetter, 2, NULL);

  cls_Texture = pkNewClass(vm, "Texture", NULL, raylib, _TextureNew, _TextureDelete, "Texture, tex data stored in GPU memory (VRAM)");
  pkClassAddMethod(vm, cls_Texture, "@getter",  _TextureGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Texture, "@setter",  _TextureSetter, 2, NULL);

  cls_RenderTexture = pkNewClass(vm, "RenderTexture", NULL, raylib, _RenderTextureNew, _RenderTextureDelete, "RenderTexture, fbo for texture rendering");
  pkClassAddMethod(vm, cls_RenderTexture, "@getter",  _RenderTextureGetter, 1, NULL);
  pkClassAddMethod(vm, cls_RenderTexture, "@setter",  _RenderTextureSetter, 2, NULL);

  cls_NPatchInfo = pkNewClass(vm, "NPatchInfo", NULL, raylib, _NPatchInfoNew, _NPatchInfoDelete, "NPatchInfo, n-patch layout info");
  pkClassAddMethod(vm, cls_NPatchInfo, "@getter",  _NPatchInfoGetter, 1, NULL);
  pkClassAddMethod(vm, cls_NPatchInfo, "@setter",  _NPatchInfoSetter, 2, NULL);

  cls_GlyphInfo = pkNewClass(vm, "GlyphInfo", NULL, raylib, _GlyphInfoNew, _GlyphInfoDelete, "GlyphInfo, font characters glyphs info");
  pkClassAddMethod(vm, cls_GlyphInfo, "@getter",  _GlyphInfoGetter, 1, NULL);
  pkClassAddMethod(vm, cls_GlyphInfo, "@setter",  _GlyphInfoSetter, 2, NULL);

  cls_Font = pkNewClass(vm, "Font", NULL, raylib, _FontNew, _FontDelete, "Font, font texture and GlyphInfo array data");
  pkClassAddMethod(vm, cls_Font, "@getter",  _FontGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Font, "@setter",  _FontSetter, 2, NULL);

  cls_Camera3D = pkNewClass(vm, "Camera3D", NULL, raylib, _Camera3DNew, _Camera3DDelete, "Camera, defines position/orientation in 3d space");
  pkClassAddMethod(vm, cls_Camera3D, "@getter",  _Camera3DGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Camera3D, "@setter",  _Camera3DSetter, 2, NULL);

  cls_Camera2D = pkNewClass(vm, "Camera2D", NULL, raylib, _Camera2DNew, _Camera2DDelete, "Camera2D, defines position/orientation in 2d space");
  pkClassAddMethod(vm, cls_Camera2D, "@getter",  _Camera2DGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Camera2D, "@setter",  _Camera2DSetter, 2, NULL);

  cls_Mesh = pkNewClass(vm, "Mesh", NULL, raylib, _MeshNew, _MeshDelete, "Mesh, vertex data and vao/vbo");
  pkClassAddMethod(vm, cls_Mesh, "@getter",  _MeshGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Mesh, "@setter",  _MeshSetter, 2, NULL);

  cls_Shader = pkNewClass(vm, "Shader", NULL, raylib, _ShaderNew, _ShaderDelete, "Shader");
  pkClassAddMethod(vm, cls_Shader, "@getter",  _ShaderGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Shader, "@setter",  _ShaderSetter, 2, NULL);

  cls_MaterialMap = pkNewClass(vm, "MaterialMap", NULL, raylib, _MaterialMapNew, _MaterialMapDelete, "MaterialMap");
  pkClassAddMethod(vm, cls_MaterialMap, "@getter",  _MaterialMapGetter, 1, NULL);
  pkClassAddMethod(vm, cls_MaterialMap, "@setter",  _MaterialMapSetter, 2, NULL);

  cls_Material = pkNewClass(vm, "Material", NULL, raylib, _MaterialNew, _MaterialDelete, "Material, includes shader and maps");
  pkClassAddMethod(vm, cls_Material, "@getter",  _MaterialGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Material, "@setter",  _MaterialSetter, 2, NULL);

  cls_Transform = pkNewClass(vm, "Transform", NULL, raylib, _TransformNew, _TransformDelete, "Transform, vectex transformation data");
  pkClassAddMethod(vm, cls_Transform, "@getter",  _TransformGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Transform, "@setter",  _TransformSetter, 2, NULL);

  cls_BoneInfo = pkNewClass(vm, "BoneInfo", NULL, raylib, _BoneInfoNew, _BoneInfoDelete, "Bone, skeletal animation bone");
  pkClassAddMethod(vm, cls_BoneInfo, "@getter",  _BoneInfoGetter, 1, NULL);
  pkClassAddMethod(vm, cls_BoneInfo, "@setter",  _BoneInfoSetter, 2, NULL);

  cls_Model = pkNewClass(vm, "Model", NULL, raylib, _ModelNew, _ModelDelete, "Model, meshes, materials and animation data");
  pkClassAddMethod(vm, cls_Model, "@getter",  _ModelGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Model, "@setter",  _ModelSetter, 2, NULL);

  cls_ModelAnimation = pkNewClass(vm, "ModelAnimation", NULL, raylib, _ModelAnimationNew, _ModelAnimationDelete, "ModelAnimation");
  pkClassAddMethod(vm, cls_ModelAnimation, "@getter",  _ModelAnimationGetter, 1, NULL);
  pkClassAddMethod(vm, cls_ModelAnimation, "@setter",  _ModelAnimationSetter, 2, NULL);

  cls_Ray = pkNewClass(vm, "Ray", NULL, raylib, _RayNew, _RayDelete, "Ray, ray for raycasting");
  pkClassAddMethod(vm, cls_Ray, "@getter",  _RayGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Ray, "@setter",  _RaySetter, 2, NULL);

  cls_RayCollision = pkNewClass(vm, "RayCollision", NULL, raylib, _RayCollisionNew, _RayCollisionDelete, "RayCollision, ray hit information");
  pkClassAddMethod(vm, cls_RayCollision, "@getter",  _RayCollisionGetter, 1, NULL);
  pkClassAddMethod(vm, cls_RayCollision, "@setter",  _RayCollisionSetter, 2, NULL);

  cls_BoundingBox = pkNewClass(vm, "BoundingBox", NULL, raylib, _BoundingBoxNew, _BoundingBoxDelete, "BoundingBox");
  pkClassAddMethod(vm, cls_BoundingBox, "@getter",  _BoundingBoxGetter, 1, NULL);
  pkClassAddMethod(vm, cls_BoundingBox, "@setter",  _BoundingBoxSetter, 2, NULL);

  cls_Wave = pkNewClass(vm, "Wave", NULL, raylib, _WaveNew, _WaveDelete, "Wave, audio wave data");
  pkClassAddMethod(vm, cls_Wave, "@getter",  _WaveGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Wave, "@setter",  _WaveSetter, 2, NULL);

  cls_AudioStream = pkNewClass(vm, "AudioStream", NULL, raylib, _AudioStreamNew, _AudioStreamDelete, "AudioStream, custom audio stream");
  pkClassAddMethod(vm, cls_AudioStream, "@getter",  _AudioStreamGetter, 1, NULL);
  pkClassAddMethod(vm, cls_AudioStream, "@setter",  _AudioStreamSetter, 2, NULL);

  cls_Sound = pkNewClass(vm, "Sound", NULL, raylib, _SoundNew, _SoundDelete, "Sound");
  pkClassAddMethod(vm, cls_Sound, "@getter",  _SoundGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Sound, "@setter",  _SoundSetter, 2, NULL);

  cls_Music = pkNewClass(vm, "Music", NULL, raylib, _MusicNew, _MusicDelete, "Music, audio stream, anything longer than ~10 seconds should be streamed");
  pkClassAddMethod(vm, cls_Music, "@getter",  _MusicGetter, 1, NULL);
  pkClassAddMethod(vm, cls_Music, "@setter",  _MusicSetter, 2, NULL);

  cls_VrDeviceInfo = pkNewClass(vm, "VrDeviceInfo", NULL, raylib, _VrDeviceInfoNew, _VrDeviceInfoDelete, "VrDeviceInfo, Head-Mounted-Display device parameters");
  pkClassAddMethod(vm, cls_VrDeviceInfo, "@getter",  _VrDeviceInfoGetter, 1, NULL);
  pkClassAddMethod(vm, cls_VrDeviceInfo, "@setter",  _VrDeviceInfoSetter, 2, NULL);

  cls_VrStereoConfig = pkNewClass(vm, "VrStereoConfig", NULL, raylib, _VrStereoConfigNew, _VrStereoConfigDelete, "VrStereoConfig, VR stereo rendering configuration for simulator");
  pkClassAddMethod(vm, cls_VrStereoConfig, "@getter",  _VrStereoConfigGetter, 1, NULL);
  pkClassAddMethod(vm, cls_VrStereoConfig, "@setter",  _VrStereoConfigSetter, 2, NULL);

  pkModuleAddFunction(vm, raylib, "InitWindow",   _InitWindow, 3, "Initialize window and OpenGL context");
  pkModuleAddFunction(vm, raylib, "WindowShouldClose",   _WindowShouldClose, 0, "Check if KEY_ESCAPE pressed or Close icon pressed");
  pkModuleAddFunction(vm, raylib, "CloseWindow",   _CloseWindow, 0, "Close window and unload OpenGL context");
  pkModuleAddFunction(vm, raylib, "IsWindowReady",   _IsWindowReady, 0, "Check if window has been initialized successfully");
  pkModuleAddFunction(vm, raylib, "IsWindowFullscreen",   _IsWindowFullscreen, 0, "Check if window is currently fullscreen");
  pkModuleAddFunction(vm, raylib, "IsWindowHidden",   _IsWindowHidden, 0, "Check if window is currently hidden (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "IsWindowMinimized",   _IsWindowMinimized, 0, "Check if window is currently minimized (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "IsWindowMaximized",   _IsWindowMaximized, 0, "Check if window is currently maximized (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "IsWindowFocused",   _IsWindowFocused, 0, "Check if window is currently focused (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "IsWindowResized",   _IsWindowResized, 0, "Check if window has been resized last frame");
  pkModuleAddFunction(vm, raylib, "IsWindowState",   _IsWindowState, 1, "Check if one specific window flag is enabled");
  pkModuleAddFunction(vm, raylib, "SetWindowState",   _SetWindowState, 1, "Set window configuration state using flags");
  pkModuleAddFunction(vm, raylib, "ClearWindowState",   _ClearWindowState, 1, "Clear window configuration state flags");
  pkModuleAddFunction(vm, raylib, "ToggleFullscreen",   _ToggleFullscreen, 0, "Toggle window state: fullscreen/windowed (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "MaximizeWindow",   _MaximizeWindow, 0, "Set window state: maximized, if resizable (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "MinimizeWindow",   _MinimizeWindow, 0, "Set window state: minimized, if resizable (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "RestoreWindow",   _RestoreWindow, 0, "Set window state: not minimized/maximized (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "SetWindowIcon",   _SetWindowIcon, 1, "Set icon for window (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "SetWindowTitle",   _SetWindowTitle, 1, "Set title for window (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "SetWindowPosition",   _SetWindowPosition, 2, "Set window position on screen (only PLATFORM_DESKTOP)");
  pkModuleAddFunction(vm, raylib, "SetWindowMonitor",   _SetWindowMonitor, 1, "Set monitor for the current window (fullscreen mode)");
  pkModuleAddFunction(vm, raylib, "SetWindowMinSize",   _SetWindowMinSize, 2, "Set window minimum dimensions (for FLAG_WINDOW_RESIZABLE)");
  pkModuleAddFunction(vm, raylib, "SetWindowSize",   _SetWindowSize, 2, "Set window dimensions");
  pkModuleAddFunction(vm, raylib, "GetScreenWidth",   _GetScreenWidth, 0, "Get current screen width");
  pkModuleAddFunction(vm, raylib, "GetScreenHeight",   _GetScreenHeight, 0, "Get current screen height");
  pkModuleAddFunction(vm, raylib, "GetMonitorCount",   _GetMonitorCount, 0, "Get number of connected monitors");
  pkModuleAddFunction(vm, raylib, "GetCurrentMonitor",   _GetCurrentMonitor, 0, "Get current connected monitor");
  pkModuleAddFunction(vm, raylib, "GetMonitorPosition",   _GetMonitorPosition, 1, "Get specified monitor position");
  pkModuleAddFunction(vm, raylib, "GetMonitorWidth",   _GetMonitorWidth, 1, "Get specified monitor width (max available by monitor)");
  pkModuleAddFunction(vm, raylib, "GetMonitorHeight",   _GetMonitorHeight, 1, "Get specified monitor height (max available by monitor)");
  pkModuleAddFunction(vm, raylib, "GetMonitorPhysicalWidth",   _GetMonitorPhysicalWidth, 1, "Get specified monitor physical width in millimetres");
  pkModuleAddFunction(vm, raylib, "GetMonitorPhysicalHeight",   _GetMonitorPhysicalHeight, 1, "Get specified monitor physical height in millimetres");
  pkModuleAddFunction(vm, raylib, "GetMonitorRefreshRate",   _GetMonitorRefreshRate, 1, "Get specified monitor refresh rate");
  pkModuleAddFunction(vm, raylib, "GetWindowPosition",   _GetWindowPosition, 0, "Get window position XY on monitor");
  pkModuleAddFunction(vm, raylib, "GetWindowScaleDPI",   _GetWindowScaleDPI, 0, "Get window scale DPI factor");
  pkModuleAddFunction(vm, raylib, "GetMonitorName",   _GetMonitorName, 1, "Get the human-readable, UTF-8 encoded name of the primary monitor");
  pkModuleAddFunction(vm, raylib, "SetClipboardText",   _SetClipboardText, 1, "Set clipboard text content");
  pkModuleAddFunction(vm, raylib, "GetClipboardText",   _GetClipboardText, 0, "Get clipboard text content");
  pkModuleAddFunction(vm, raylib, "SwapScreenBuffer",   _SwapScreenBuffer, 0, "Swap back buffer with front buffer (screen drawing)");
  pkModuleAddFunction(vm, raylib, "PollInputEvents",   _PollInputEvents, 0, "Register all input events");
  pkModuleAddFunction(vm, raylib, "WaitTime",   _WaitTime, 1, "Wait for some milliseconds (halt program execution)");
  pkModuleAddFunction(vm, raylib, "ShowCursor",   _ShowCursor, 0, "Shows cursor");
  pkModuleAddFunction(vm, raylib, "HideCursor",   _HideCursor, 0, "Hides cursor");
  pkModuleAddFunction(vm, raylib, "IsCursorHidden",   _IsCursorHidden, 0, "Check if cursor is not visible");
  pkModuleAddFunction(vm, raylib, "EnableCursor",   _EnableCursor, 0, "Enables cursor (unlock cursor)");
  pkModuleAddFunction(vm, raylib, "DisableCursor",   _DisableCursor, 0, "Disables cursor (lock cursor)");
  pkModuleAddFunction(vm, raylib, "IsCursorOnScreen",   _IsCursorOnScreen, 0, "Check if cursor is on the screen");
  pkModuleAddFunction(vm, raylib, "ClearBackground",   _ClearBackground, 1, "Set background color (framebuffer clear color)");
  pkModuleAddFunction(vm, raylib, "BeginDrawing",   _BeginDrawing, 0, "Setup canvas (framebuffer) to start drawing");
  pkModuleAddFunction(vm, raylib, "EndDrawing",   _EndDrawing, 0, "End canvas drawing and swap buffers (double buffering)");
  pkModuleAddFunction(vm, raylib, "BeginMode2D",   _BeginMode2D, 1, "Begin 2D mode with custom camera (2D)");
  pkModuleAddFunction(vm, raylib, "EndMode2D",   _EndMode2D, 0, "Ends 2D mode with custom camera");
  pkModuleAddFunction(vm, raylib, "BeginMode3D",   _BeginMode3D, 1, "Begin 3D mode with custom camera (3D)");
  pkModuleAddFunction(vm, raylib, "EndMode3D",   _EndMode3D, 0, "Ends 3D mode and returns to default 2D orthographic mode");
  pkModuleAddFunction(vm, raylib, "BeginTextureMode",   _BeginTextureMode, 1, "Begin drawing to render texture");
  pkModuleAddFunction(vm, raylib, "EndTextureMode",   _EndTextureMode, 0, "Ends drawing to render texture");
  pkModuleAddFunction(vm, raylib, "BeginShaderMode",   _BeginShaderMode, 1, "Begin custom shader drawing");
  pkModuleAddFunction(vm, raylib, "EndShaderMode",   _EndShaderMode, 0, "End custom shader drawing (use default shader)");
  pkModuleAddFunction(vm, raylib, "BeginBlendMode",   _BeginBlendMode, 1, "Begin blending mode (alpha, additive, multiplied, subtract, custom)");
  pkModuleAddFunction(vm, raylib, "EndBlendMode",   _EndBlendMode, 0, "End blending mode (reset to default: alpha blending)");
  pkModuleAddFunction(vm, raylib, "BeginScissorMode",   _BeginScissorMode, 4, "Begin scissor mode (define screen area for following drawing)");
  pkModuleAddFunction(vm, raylib, "EndScissorMode",   _EndScissorMode, 0, "End scissor mode");
  pkModuleAddFunction(vm, raylib, "BeginVrStereoMode",   _BeginVrStereoMode, 1, "Begin stereo rendering (requires VR simulator)");
  pkModuleAddFunction(vm, raylib, "EndVrStereoMode",   _EndVrStereoMode, 0, "End stereo rendering (requires VR simulator)");
  pkModuleAddFunction(vm, raylib, "LoadVrStereoConfig",   _LoadVrStereoConfig, 1, "Load VR stereo config for VR simulator device parameters");
  pkModuleAddFunction(vm, raylib, "UnloadVrStereoConfig",   _UnloadVrStereoConfig, 1, "Unload VR stereo config");
  pkModuleAddFunction(vm, raylib, "LoadShader",   _LoadShader, 2, "Load shader from files and bind default locations");
  pkModuleAddFunction(vm, raylib, "LoadShaderFromMemory",   _LoadShaderFromMemory, 2, "Load shader from code strings and bind default locations");
  pkModuleAddFunction(vm, raylib, "GetShaderLocation",   _GetShaderLocation, 2, "Get shader uniform location");
  pkModuleAddFunction(vm, raylib, "GetShaderLocationAttrib",   _GetShaderLocationAttrib, 2, "Get shader attribute location");
  pkModuleAddFunction(vm, raylib, "SetShaderValueMatrix",   _SetShaderValueMatrix, 3, "Set shader uniform value (matrix 4x4)");
  pkModuleAddFunction(vm, raylib, "SetShaderValueTexture",   _SetShaderValueTexture, 3, "Set shader uniform value for texture (sampler2d)");
  pkModuleAddFunction(vm, raylib, "UnloadShader",   _UnloadShader, 1, "Unload shader from GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "GetMouseRay",   _GetMouseRay, 2, "Get a ray trace from mouse position");
  pkModuleAddFunction(vm, raylib, "GetCameraMatrix",   _GetCameraMatrix, 1, "Get camera transform matrix (view matrix)");
  pkModuleAddFunction(vm, raylib, "GetCameraMatrix2D",   _GetCameraMatrix2D, 1, "Get camera 2d transform matrix");
  pkModuleAddFunction(vm, raylib, "GetWorldToScreen",   _GetWorldToScreen, 2, "Get the screen space position for a 3d world space position");
  pkModuleAddFunction(vm, raylib, "GetWorldToScreenEx",   _GetWorldToScreenEx, 4, "Get size position for a 3d world space position");
  pkModuleAddFunction(vm, raylib, "GetWorldToScreen2D",   _GetWorldToScreen2D, 2, "Get the screen space position for a 2d camera world space position");
  pkModuleAddFunction(vm, raylib, "GetScreenToWorld2D",   _GetScreenToWorld2D, 2, "Get the world space position for a 2d camera screen space position");
  pkModuleAddFunction(vm, raylib, "SetTargetFPS",   _SetTargetFPS, 1, "Set target FPS (maximum)");
  pkModuleAddFunction(vm, raylib, "GetFPS",   _GetFPS, 0, "Get current FPS");
  pkModuleAddFunction(vm, raylib, "GetFrameTime",   _GetFrameTime, 0, "Get time in seconds for last frame drawn (delta time)");
  pkModuleAddFunction(vm, raylib, "GetTime",   _GetTime, 0, "Get elapsed time in seconds since InitWindow()");
  pkModuleAddFunction(vm, raylib, "GetRandomValue",   _GetRandomValue, 2, "Get a random value between min and max (both included)");
  pkModuleAddFunction(vm, raylib, "SetRandomSeed",   _SetRandomSeed, 1, "Set the seed for the random number generator");
  pkModuleAddFunction(vm, raylib, "TakeScreenshot",   _TakeScreenshot, 1, "Takes a screenshot of current screen (filename extension defines format)");
  pkModuleAddFunction(vm, raylib, "SetConfigFlags",   _SetConfigFlags, 1, "Setup init configuration flags (view FLAGS)");
  pkModuleAddFunction(vm, raylib, "SetTraceLogLevel",   _SetTraceLogLevel, 1, "Set the current threshold (minimum) log level");
  pkModuleAddFunction(vm, raylib, "FileExists",   _FileExists, 1, "Check if file exists");
  pkModuleAddFunction(vm, raylib, "DirectoryExists",   _DirectoryExists, 1, "Check if a directory path exists");
  pkModuleAddFunction(vm, raylib, "IsFileExtension",   _IsFileExtension, 2, "Check file extension (including point: .png, .wav)");
  pkModuleAddFunction(vm, raylib, "GetFileExtension",   _GetFileExtension, 1, "Get pointer to extension for a filename string (includes dot: '.png')");
  pkModuleAddFunction(vm, raylib, "GetFileName",   _GetFileName, 1, "Get pointer to filename for a path string");
  pkModuleAddFunction(vm, raylib, "GetFileNameWithoutExt",   _GetFileNameWithoutExt, 1, "Get filename string without extension (uses static string)");
  pkModuleAddFunction(vm, raylib, "GetDirectoryPath",   _GetDirectoryPath, 1, "Get full path for a given fileName with path (uses static string)");
  pkModuleAddFunction(vm, raylib, "GetPrevDirectoryPath",   _GetPrevDirectoryPath, 1, "Get previous directory path for a given path (uses static string)");
  pkModuleAddFunction(vm, raylib, "GetWorkingDirectory",   _GetWorkingDirectory, 0, "Get current working directory (uses static string)");
  pkModuleAddFunction(vm, raylib, "ClearDirectoryFiles",   _ClearDirectoryFiles, 0, "Clear directory files paths buffers (free memory)");
  pkModuleAddFunction(vm, raylib, "ChangeDirectory",   _ChangeDirectory, 1, "Change working directory, return true on success");
  pkModuleAddFunction(vm, raylib, "IsFileDropped",   _IsFileDropped, 0, "Check if a file has been dropped into window");
  pkModuleAddFunction(vm, raylib, "ClearDroppedFiles",   _ClearDroppedFiles, 0, "Clear dropped files paths buffer (free memory)");
  pkModuleAddFunction(vm, raylib, "GetFileModTime",   _GetFileModTime, 1, "Get file modification time (last write time)");
  pkModuleAddFunction(vm, raylib, "SaveStorageValue",   _SaveStorageValue, 2, "Save integer value to storage file (to defined position), returns true on success");
  pkModuleAddFunction(vm, raylib, "LoadStorageValue",   _LoadStorageValue, 1, "Load integer value from storage file (from defined position)");
  pkModuleAddFunction(vm, raylib, "OpenURL",   _OpenURL, 1, "Open URL with default system browser (if available)");
  pkModuleAddFunction(vm, raylib, "IsKeyPressed",   _IsKeyPressed, 1, "Check if a key has been pressed once");
  pkModuleAddFunction(vm, raylib, "IsKeyDown",   _IsKeyDown, 1, "Check if a key is being pressed");
  pkModuleAddFunction(vm, raylib, "IsKeyReleased",   _IsKeyReleased, 1, "Check if a key has been released once");
  pkModuleAddFunction(vm, raylib, "IsKeyUp",   _IsKeyUp, 1, "Check if a key is NOT being pressed");
  pkModuleAddFunction(vm, raylib, "SetExitKey",   _SetExitKey, 1, "Set a custom key to exit program (default is ESC)");
  pkModuleAddFunction(vm, raylib, "GetKeyPressed",   _GetKeyPressed, 0, "Get key pressed (keycode), call it multiple times for keys queued, returns 0 when the queue is empty");
  pkModuleAddFunction(vm, raylib, "GetCharPressed",   _GetCharPressed, 0, "Get char pressed (unicode), call it multiple times for chars queued, returns 0 when the queue is empty");
  pkModuleAddFunction(vm, raylib, "IsGamepadAvailable",   _IsGamepadAvailable, 1, "Check if a gamepad is available");
  pkModuleAddFunction(vm, raylib, "GetGamepadName",   _GetGamepadName, 1, "Get gamepad internal name id");
  pkModuleAddFunction(vm, raylib, "IsGamepadButtonPressed",   _IsGamepadButtonPressed, 2, "Check if a gamepad button has been pressed once");
  pkModuleAddFunction(vm, raylib, "IsGamepadButtonDown",   _IsGamepadButtonDown, 2, "Check if a gamepad button is being pressed");
  pkModuleAddFunction(vm, raylib, "IsGamepadButtonReleased",   _IsGamepadButtonReleased, 2, "Check if a gamepad button has been released once");
  pkModuleAddFunction(vm, raylib, "IsGamepadButtonUp",   _IsGamepadButtonUp, 2, "Check if a gamepad button is NOT being pressed");
  pkModuleAddFunction(vm, raylib, "GetGamepadButtonPressed",   _GetGamepadButtonPressed, 0, "Get the last gamepad button pressed");
  pkModuleAddFunction(vm, raylib, "GetGamepadAxisCount",   _GetGamepadAxisCount, 1, "Get gamepad axis count for a gamepad");
  pkModuleAddFunction(vm, raylib, "GetGamepadAxisMovement",   _GetGamepadAxisMovement, 2, "Get axis movement value for a gamepad axis");
  pkModuleAddFunction(vm, raylib, "SetGamepadMappings",   _SetGamepadMappings, 1, "Set internal gamepad mappings (SDL_GameControllerDB)");
  pkModuleAddFunction(vm, raylib, "IsMouseButtonPressed",   _IsMouseButtonPressed, 1, "Check if a mouse button has been pressed once");
  pkModuleAddFunction(vm, raylib, "IsMouseButtonDown",   _IsMouseButtonDown, 1, "Check if a mouse button is being pressed");
  pkModuleAddFunction(vm, raylib, "IsMouseButtonReleased",   _IsMouseButtonReleased, 1, "Check if a mouse button has been released once");
  pkModuleAddFunction(vm, raylib, "IsMouseButtonUp",   _IsMouseButtonUp, 1, "Check if a mouse button is NOT being pressed");
  pkModuleAddFunction(vm, raylib, "GetMouseX",   _GetMouseX, 0, "Get mouse position X");
  pkModuleAddFunction(vm, raylib, "GetMouseY",   _GetMouseY, 0, "Get mouse position Y");
  pkModuleAddFunction(vm, raylib, "GetMousePosition",   _GetMousePosition, 0, "Get mouse position XY");
  pkModuleAddFunction(vm, raylib, "GetMouseDelta",   _GetMouseDelta, 0, "Get mouse delta between frames");
  pkModuleAddFunction(vm, raylib, "SetMousePosition",   _SetMousePosition, 2, "Set mouse position XY");
  pkModuleAddFunction(vm, raylib, "SetMouseOffset",   _SetMouseOffset, 2, "Set mouse offset");
  pkModuleAddFunction(vm, raylib, "SetMouseScale",   _SetMouseScale, 2, "Set mouse scaling");
  pkModuleAddFunction(vm, raylib, "GetMouseWheelMove",   _GetMouseWheelMove, 0, "Get mouse wheel movement Y");
  pkModuleAddFunction(vm, raylib, "SetMouseCursor",   _SetMouseCursor, 1, "Set mouse cursor");
  pkModuleAddFunction(vm, raylib, "GetTouchX",   _GetTouchX, 0, "Get touch position X for touch point 0 (relative to screen size)");
  pkModuleAddFunction(vm, raylib, "GetTouchY",   _GetTouchY, 0, "Get touch position Y for touch point 0 (relative to screen size)");
  pkModuleAddFunction(vm, raylib, "GetTouchPosition",   _GetTouchPosition, 1, "Get touch position XY for a touch point index (relative to screen size)");
  pkModuleAddFunction(vm, raylib, "GetTouchPointId",   _GetTouchPointId, 1, "Get touch point identifier for given index");
  pkModuleAddFunction(vm, raylib, "GetTouchPointCount",   _GetTouchPointCount, 0, "Get number of touch points");
  pkModuleAddFunction(vm, raylib, "SetGesturesEnabled",   _SetGesturesEnabled, 1, "Enable a set of gestures using flags");
  pkModuleAddFunction(vm, raylib, "IsGestureDetected",   _IsGestureDetected, 1, "Check if a gesture have been detected");
  pkModuleAddFunction(vm, raylib, "GetGestureDetected",   _GetGestureDetected, 0, "Get latest detected gesture");
  pkModuleAddFunction(vm, raylib, "GetGestureHoldDuration",   _GetGestureHoldDuration, 0, "Get gesture hold time in milliseconds");
  pkModuleAddFunction(vm, raylib, "GetGestureDragVector",   _GetGestureDragVector, 0, "Get gesture drag vector");
  pkModuleAddFunction(vm, raylib, "GetGestureDragAngle",   _GetGestureDragAngle, 0, "Get gesture drag angle");
  pkModuleAddFunction(vm, raylib, "GetGesturePinchVector",   _GetGesturePinchVector, 0, "Get gesture pinch delta");
  pkModuleAddFunction(vm, raylib, "GetGesturePinchAngle",   _GetGesturePinchAngle, 0, "Get gesture pinch angle");
  pkModuleAddFunction(vm, raylib, "SetCameraMode",   _SetCameraMode, 2, "Set camera mode (multiple camera modes available)");
  pkModuleAddFunction(vm, raylib, "UpdateCamera",   _UpdateCamera, 1, "Update camera position for selected mode");
  pkModuleAddFunction(vm, raylib, "SetCameraPanControl",   _SetCameraPanControl, 1, "Set camera pan key to combine with mouse movement (free camera)");
  pkModuleAddFunction(vm, raylib, "SetCameraAltControl",   _SetCameraAltControl, 1, "Set camera alt key to combine with mouse movement (free camera)");
  pkModuleAddFunction(vm, raylib, "SetCameraSmoothZoomControl",   _SetCameraSmoothZoomControl, 1, "Set camera smooth zoom key to combine with mouse (free camera)");
  pkModuleAddFunction(vm, raylib, "SetCameraMoveControls",   _SetCameraMoveControls, 6, "Set camera move controls (1st person and 3rd person cameras)");
  pkModuleAddFunction(vm, raylib, "SetShapesTexture",   _SetShapesTexture, 2, "Set texture and rectangle to be used on shapes drawing");
  pkModuleAddFunction(vm, raylib, "DrawPixel",   _DrawPixel, 3, "Draw a pixel");
  pkModuleAddFunction(vm, raylib, "DrawPixelV",   _DrawPixelV, 2, "Draw a pixel (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawLine",   _DrawLine, 5, "Draw a line");
  pkModuleAddFunction(vm, raylib, "DrawLineV",   _DrawLineV, 3, "Draw a line (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawLineEx",   _DrawLineEx, 4, "Draw a line defining thickness");
  pkModuleAddFunction(vm, raylib, "DrawLineBezier",   _DrawLineBezier, 4, "Draw a line using cubic-bezier curves in-out");
  pkModuleAddFunction(vm, raylib, "DrawLineBezierQuad",   _DrawLineBezierQuad, 5, "Draw line using quadratic bezier curves with a control point");
  pkModuleAddFunction(vm, raylib, "DrawLineBezierCubic",   _DrawLineBezierCubic, 6, "Draw line using cubic bezier curves with 2 control points");
  pkModuleAddFunction(vm, raylib, "DrawLineStrip",   _DrawLineStrip, 3, "Draw lines sequence");
  pkModuleAddFunction(vm, raylib, "DrawCircle",   _DrawCircle, 4, "Draw a color-filled circle");
  pkModuleAddFunction(vm, raylib, "DrawCircleSector",   _DrawCircleSector, 6, "Draw a piece of a circle");
  pkModuleAddFunction(vm, raylib, "DrawCircleSectorLines",   _DrawCircleSectorLines, 6, "Draw circle sector outline");
  pkModuleAddFunction(vm, raylib, "DrawCircleGradient",   _DrawCircleGradient, 5, "Draw a gradient-filled circle");
  pkModuleAddFunction(vm, raylib, "DrawCircleV",   _DrawCircleV, 3, "Draw a color-filled circle (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawCircleLines",   _DrawCircleLines, 4, "Draw circle outline");
  pkModuleAddFunction(vm, raylib, "DrawEllipse",   _DrawEllipse, 5, "Draw ellipse");
  pkModuleAddFunction(vm, raylib, "DrawEllipseLines",   _DrawEllipseLines, 5, "Draw ellipse outline");
  pkModuleAddFunction(vm, raylib, "DrawRing",   _DrawRing, 7, "Draw ring");
  pkModuleAddFunction(vm, raylib, "DrawRingLines",   _DrawRingLines, 7, "Draw ring outline");
  pkModuleAddFunction(vm, raylib, "DrawRectangle",   _DrawRectangle, 5, "Draw a color-filled rectangle");
  pkModuleAddFunction(vm, raylib, "DrawRectangleV",   _DrawRectangleV, 3, "Draw a color-filled rectangle (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawRectangleRec",   _DrawRectangleRec, 2, "Draw a color-filled rectangle");
  pkModuleAddFunction(vm, raylib, "DrawRectanglePro",   _DrawRectanglePro, 4, "Draw a color-filled rectangle with pro parameters");
  pkModuleAddFunction(vm, raylib, "DrawRectangleGradientV",   _DrawRectangleGradientV, 6, "Draw a vertical-gradient-filled rectangle");
  pkModuleAddFunction(vm, raylib, "DrawRectangleGradientH",   _DrawRectangleGradientH, 6, "Draw a horizontal-gradient-filled rectangle");
  pkModuleAddFunction(vm, raylib, "DrawRectangleGradientEx",   _DrawRectangleGradientEx, 5, "Draw a gradient-filled rectangle with custom vertex colors");
  pkModuleAddFunction(vm, raylib, "DrawRectangleLines",   _DrawRectangleLines, 5, "Draw rectangle outline");
  pkModuleAddFunction(vm, raylib, "DrawRectangleLinesEx",   _DrawRectangleLinesEx, 3, "Draw rectangle outline with extended parameters");
  pkModuleAddFunction(vm, raylib, "DrawRectangleRounded",   _DrawRectangleRounded, 4, "Draw rectangle with rounded edges");
  pkModuleAddFunction(vm, raylib, "DrawRectangleRoundedLines",   _DrawRectangleRoundedLines, 5, "Draw rectangle with rounded edges outline");
  pkModuleAddFunction(vm, raylib, "DrawTriangle",   _DrawTriangle, 4, "Draw a color-filled triangle (vertex in counter-clockwise order!)");
  pkModuleAddFunction(vm, raylib, "DrawTriangleLines",   _DrawTriangleLines, 4, "Draw triangle outline (vertex in counter-clockwise order!)");
  pkModuleAddFunction(vm, raylib, "DrawTriangleFan",   _DrawTriangleFan, 3, "Draw a triangle fan defined by points (first vertex is the center)");
  pkModuleAddFunction(vm, raylib, "DrawTriangleStrip",   _DrawTriangleStrip, 3, "Draw a triangle strip defined by points");
  pkModuleAddFunction(vm, raylib, "DrawPoly",   _DrawPoly, 5, "Draw a regular polygon (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawPolyLines",   _DrawPolyLines, 5, "Draw a polygon outline of n sides");
  pkModuleAddFunction(vm, raylib, "DrawPolyLinesEx",   _DrawPolyLinesEx, 6, "Draw a polygon outline of n sides with extended parameters");
  pkModuleAddFunction(vm, raylib, "CheckCollisionRecs",   _CheckCollisionRecs, 2, "Check collision between two rectangles");
  pkModuleAddFunction(vm, raylib, "CheckCollisionCircles",   _CheckCollisionCircles, 4, "Check collision between two circles");
  pkModuleAddFunction(vm, raylib, "CheckCollisionCircleRec",   _CheckCollisionCircleRec, 3, "Check collision between circle and rectangle");
  pkModuleAddFunction(vm, raylib, "CheckCollisionPointRec",   _CheckCollisionPointRec, 2, "Check if point is inside rectangle");
  pkModuleAddFunction(vm, raylib, "CheckCollisionPointCircle",   _CheckCollisionPointCircle, 3, "Check if point is inside circle");
  pkModuleAddFunction(vm, raylib, "CheckCollisionPointTriangle",   _CheckCollisionPointTriangle, 4, "Check if point is inside a triangle");
  pkModuleAddFunction(vm, raylib, "CheckCollisionLines",   _CheckCollisionLines, 5, "Check the collision between two lines defined by two points each, returns collision point by reference");
  pkModuleAddFunction(vm, raylib, "CheckCollisionPointLine",   _CheckCollisionPointLine, 4, "Check if point belongs to line created between two points [p1] and [p2] with defined margin in pixels [threshold]");
  pkModuleAddFunction(vm, raylib, "GetCollisionRec",   _GetCollisionRec, 2, "Get collision rectangle for two rectangles collision");
  pkModuleAddFunction(vm, raylib, "LoadImage",   _LoadImage, 1, "Load image from file into CPU memory (RAM)");
  pkModuleAddFunction(vm, raylib, "LoadImageRaw",   _LoadImageRaw, 5, "Load image from RAW file data");
  pkModuleAddFunction(vm, raylib, "LoadImageFromTexture",   _LoadImageFromTexture, 1, "Load image from GPU texture data");
  pkModuleAddFunction(vm, raylib, "LoadImageFromScreen",   _LoadImageFromScreen, 0, "Load image from screen buffer and (screenshot)");
  pkModuleAddFunction(vm, raylib, "UnloadImage",   _UnloadImage, 1, "Unload image from CPU memory (RAM)");
  pkModuleAddFunction(vm, raylib, "ExportImage",   _ExportImage, 2, "Export image data to file, returns true on success");
  pkModuleAddFunction(vm, raylib, "ExportImageAsCode",   _ExportImageAsCode, 2, "Export image as code file defining an array of bytes, returns true on success");
  pkModuleAddFunction(vm, raylib, "GenImageColor",   _GenImageColor, 3, "Generate image: plain color");
  pkModuleAddFunction(vm, raylib, "GenImageGradientV",   _GenImageGradientV, 4, "Generate image: vertical gradient");
  pkModuleAddFunction(vm, raylib, "GenImageGradientH",   _GenImageGradientH, 4, "Generate image: horizontal gradient");
  pkModuleAddFunction(vm, raylib, "GenImageGradientRadial",   _GenImageGradientRadial, 5, "Generate image: radial gradient");
  pkModuleAddFunction(vm, raylib, "GenImageChecked",   _GenImageChecked, 6, "Generate image: checked");
  pkModuleAddFunction(vm, raylib, "GenImageWhiteNoise",   _GenImageWhiteNoise, 3, "Generate image: white noise");
  pkModuleAddFunction(vm, raylib, "GenImageCellular",   _GenImageCellular, 3, "Generate image: cellular algorithm, bigger tileSize means bigger cells");
  pkModuleAddFunction(vm, raylib, "ImageCopy",   _ImageCopy, 1, "Create an image duplicate (useful for transformations)");
  pkModuleAddFunction(vm, raylib, "ImageFromImage",   _ImageFromImage, 2, "Create an image from another image piece");
  pkModuleAddFunction(vm, raylib, "ImageText",   _ImageText, 3, "Create an image from text (default font)");
  pkModuleAddFunction(vm, raylib, "ImageTextEx",   _ImageTextEx, 5, "Create an image from text (custom sprite font)");
  pkModuleAddFunction(vm, raylib, "ImageFormat",   _ImageFormat, 2, "Convert image data to desired format");
  pkModuleAddFunction(vm, raylib, "ImageToPOT",   _ImageToPOT, 2, "Convert image to POT (power-of-two)");
  pkModuleAddFunction(vm, raylib, "ImageCrop",   _ImageCrop, 2, "Crop an image to a defined rectangle");
  pkModuleAddFunction(vm, raylib, "ImageAlphaCrop",   _ImageAlphaCrop, 2, "Crop image depending on alpha value");
  pkModuleAddFunction(vm, raylib, "ImageAlphaClear",   _ImageAlphaClear, 3, "Clear alpha channel to desired color");
  pkModuleAddFunction(vm, raylib, "ImageAlphaMask",   _ImageAlphaMask, 2, "Apply alpha mask to image");
  pkModuleAddFunction(vm, raylib, "ImageAlphaPremultiply",   _ImageAlphaPremultiply, 1, "Premultiply alpha channel");
  pkModuleAddFunction(vm, raylib, "ImageResize",   _ImageResize, 3, "Resize image (Bicubic scaling algorithm)");
  pkModuleAddFunction(vm, raylib, "ImageResizeNN",   _ImageResizeNN, 3, "Resize image (Nearest-Neighbor scaling algorithm)");
  pkModuleAddFunction(vm, raylib, "ImageResizeCanvas",   _ImageResizeCanvas, 6, "Resize canvas and fill with color");
  pkModuleAddFunction(vm, raylib, "ImageMipmaps",   _ImageMipmaps, 1, "Compute all mipmap levels for a provided image");
  pkModuleAddFunction(vm, raylib, "ImageDither",   _ImageDither, 5, "Dither image data to 16bpp or lower (Floyd-Steinberg dithering)");
  pkModuleAddFunction(vm, raylib, "ImageFlipVertical",   _ImageFlipVertical, 1, "Flip image vertically");
  pkModuleAddFunction(vm, raylib, "ImageFlipHorizontal",   _ImageFlipHorizontal, 1, "Flip image horizontally");
  pkModuleAddFunction(vm, raylib, "ImageRotateCW",   _ImageRotateCW, 1, "Rotate image clockwise 90deg");
  pkModuleAddFunction(vm, raylib, "ImageRotateCCW",   _ImageRotateCCW, 1, "Rotate image counter-clockwise 90deg");
  pkModuleAddFunction(vm, raylib, "ImageColorTint",   _ImageColorTint, 2, "Modify image color: tint");
  pkModuleAddFunction(vm, raylib, "ImageColorInvert",   _ImageColorInvert, 1, "Modify image color: invert");
  pkModuleAddFunction(vm, raylib, "ImageColorGrayscale",   _ImageColorGrayscale, 1, "Modify image color: grayscale");
  pkModuleAddFunction(vm, raylib, "ImageColorContrast",   _ImageColorContrast, 2, "Modify image color: contrast (-100 to 100)");
  pkModuleAddFunction(vm, raylib, "ImageColorBrightness",   _ImageColorBrightness, 2, "Modify image color: brightness (-255 to 255)");
  pkModuleAddFunction(vm, raylib, "ImageColorReplace",   _ImageColorReplace, 3, "Modify image color: replace color");
  pkModuleAddFunction(vm, raylib, "UnloadImageColors",   _UnloadImageColors, 1, "Unload color data loaded with LoadImageColors()");
  pkModuleAddFunction(vm, raylib, "UnloadImagePalette",   _UnloadImagePalette, 1, "Unload colors palette loaded with LoadImagePalette()");
  pkModuleAddFunction(vm, raylib, "GetImageAlphaBorder",   _GetImageAlphaBorder, 2, "Get image alpha border rectangle");
  pkModuleAddFunction(vm, raylib, "GetImageColor",   _GetImageColor, 3, "Get image pixel color at (x, y) position");
  pkModuleAddFunction(vm, raylib, "ImageClearBackground",   _ImageClearBackground, 2, "Clear image background with given color");
  pkModuleAddFunction(vm, raylib, "ImageDrawPixel",   _ImageDrawPixel, 4, "Draw pixel within an image");
  pkModuleAddFunction(vm, raylib, "ImageDrawPixelV",   _ImageDrawPixelV, 3, "Draw pixel within an image (Vector version)");
  pkModuleAddFunction(vm, raylib, "ImageDrawLine",   _ImageDrawLine, 6, "Draw line within an image");
  pkModuleAddFunction(vm, raylib, "ImageDrawLineV",   _ImageDrawLineV, 4, "Draw line within an image (Vector version)");
  pkModuleAddFunction(vm, raylib, "ImageDrawCircle",   _ImageDrawCircle, 5, "Draw circle within an image");
  pkModuleAddFunction(vm, raylib, "ImageDrawCircleV",   _ImageDrawCircleV, 4, "Draw circle within an image (Vector version)");
  pkModuleAddFunction(vm, raylib, "ImageDrawRectangle",   _ImageDrawRectangle, 6, "Draw rectangle within an image");
  pkModuleAddFunction(vm, raylib, "ImageDrawRectangleV",   _ImageDrawRectangleV, 4, "Draw rectangle within an image (Vector version)");
  pkModuleAddFunction(vm, raylib, "ImageDrawRectangleRec",   _ImageDrawRectangleRec, 3, "Draw rectangle within an image");
  pkModuleAddFunction(vm, raylib, "ImageDrawRectangleLines",   _ImageDrawRectangleLines, 4, "Draw rectangle lines within an image");
  pkModuleAddFunction(vm, raylib, "ImageDraw",   _ImageDraw, 5, "Draw a source image within a destination image (tint applied to source)");
  pkModuleAddFunction(vm, raylib, "ImageDrawText",   _ImageDrawText, 6, "Draw text (using default font) within an image (destination)");
  pkModuleAddFunction(vm, raylib, "ImageDrawTextEx",   _ImageDrawTextEx, 7, "Draw text (custom sprite font) within an image (destination)");
  pkModuleAddFunction(vm, raylib, "LoadTexture",   _LoadTexture, 1, "Load texture from file into GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "LoadTextureFromImage",   _LoadTextureFromImage, 1, "Load texture from image data");
  pkModuleAddFunction(vm, raylib, "LoadTextureCubemap",   _LoadTextureCubemap, 2, "Load cubemap from image, multiple image cubemap layouts supported");
  pkModuleAddFunction(vm, raylib, "LoadRenderTexture",   _LoadRenderTexture, 2, "Load texture for rendering (framebuffer)");
  pkModuleAddFunction(vm, raylib, "UnloadTexture",   _UnloadTexture, 1, "Unload texture from GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "UnloadRenderTexture",   _UnloadRenderTexture, 1, "Unload render texture from GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "GenTextureMipmaps",   _GenTextureMipmaps, 1, "Generate GPU mipmaps for a texture");
  pkModuleAddFunction(vm, raylib, "SetTextureFilter",   _SetTextureFilter, 2, "Set texture scaling filter mode");
  pkModuleAddFunction(vm, raylib, "SetTextureWrap",   _SetTextureWrap, 2, "Set texture wrapping mode");
  pkModuleAddFunction(vm, raylib, "DrawTexture",   _DrawTexture, 4, "Draw a Texture2D");
  pkModuleAddFunction(vm, raylib, "DrawTextureV",   _DrawTextureV, 3, "Draw a Texture2D with position defined as Vector2");
  pkModuleAddFunction(vm, raylib, "DrawTextureEx",   _DrawTextureEx, 5, "Draw a Texture2D with extended parameters");
  pkModuleAddFunction(vm, raylib, "DrawTextureRec",   _DrawTextureRec, 4, "Draw a part of a texture defined by a rectangle");
  pkModuleAddFunction(vm, raylib, "DrawTextureQuad",   _DrawTextureQuad, 5, "Draw texture quad with tiling and offset parameters");
  pkModuleAddFunction(vm, raylib, "DrawTextureTiled",   _DrawTextureTiled, 7, "Draw part of a texture (defined by a rectangle) with rotation and scale tiled into dest.");
  pkModuleAddFunction(vm, raylib, "DrawTexturePro",   _DrawTexturePro, 6, "Draw a part of a texture defined by a rectangle with 'pro' parameters");
  pkModuleAddFunction(vm, raylib, "DrawTextureNPatch",   _DrawTextureNPatch, 6, "Draws a texture (or part of it) that stretches or shrinks nicely");
  pkModuleAddFunction(vm, raylib, "DrawTexturePoly",   _DrawTexturePoly, 6, "Draw a textured polygon");
  pkModuleAddFunction(vm, raylib, "Fade",   _Fade, 2, "Get color with alpha applied, alpha goes from 0.0f to 1.0f");
  pkModuleAddFunction(vm, raylib, "ColorToInt",   _ColorToInt, 1, "Get hexadecimal value for a Color");
  pkModuleAddFunction(vm, raylib, "ColorNormalize",   _ColorNormalize, 1, "Get Color normalized as float [0..1]");
  pkModuleAddFunction(vm, raylib, "ColorFromNormalized",   _ColorFromNormalized, 1, "Get Color from normalized values [0..1]");
  pkModuleAddFunction(vm, raylib, "ColorToHSV",   _ColorToHSV, 1, "Get HSV values for a Color, hue [0..360], saturation/value [0..1]");
  pkModuleAddFunction(vm, raylib, "ColorFromHSV",   _ColorFromHSV, 3, "Get a Color from HSV values, hue [0..360], saturation/value [0..1]");
  pkModuleAddFunction(vm, raylib, "ColorAlpha",   _ColorAlpha, 2, "Get color with alpha applied, alpha goes from 0.0f to 1.0f");
  pkModuleAddFunction(vm, raylib, "ColorAlphaBlend",   _ColorAlphaBlend, 3, "Get src alpha-blended into dst color with tint");
  pkModuleAddFunction(vm, raylib, "GetColor",   _GetColor, 1, "Get Color structure from hexadecimal value");
  pkModuleAddFunction(vm, raylib, "GetPixelDataSize",   _GetPixelDataSize, 3, "Get pixel data size in bytes for certain format");
  pkModuleAddFunction(vm, raylib, "GetFontDefault",   _GetFontDefault, 0, "Get the default Font");
  pkModuleAddFunction(vm, raylib, "LoadFont",   _LoadFont, 1, "Load font from file into GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "LoadFontFromImage",   _LoadFontFromImage, 3, "Load font from Image (XNA style)");
  pkModuleAddFunction(vm, raylib, "UnloadFontData",   _UnloadFontData, 2, "Unload font chars info data (RAM)");
  pkModuleAddFunction(vm, raylib, "UnloadFont",   _UnloadFont, 1, "Unload Font from GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "DrawFPS",   _DrawFPS, 2, "Draw current FPS");
  pkModuleAddFunction(vm, raylib, "DrawText",   _DrawText, 5, "Draw text (using default font)");
  pkModuleAddFunction(vm, raylib, "DrawTextEx",   _DrawTextEx, 6, "Draw text using font and additional parameters");
  pkModuleAddFunction(vm, raylib, "DrawTextPro",   _DrawTextPro, 8, "Draw text using Font and pro parameters (rotation)");
  pkModuleAddFunction(vm, raylib, "DrawTextCodepoint",   _DrawTextCodepoint, 5, "Draw one character (codepoint)");
  pkModuleAddFunction(vm, raylib, "MeasureText",   _MeasureText, 2, "Measure string width for default font");
  pkModuleAddFunction(vm, raylib, "MeasureTextEx",   _MeasureTextEx, 4, "Measure string size for Font");
  pkModuleAddFunction(vm, raylib, "GetGlyphIndex",   _GetGlyphIndex, 2, "Get glyph index position in font for a codepoint (unicode character), fallback to '?' if not found");
  pkModuleAddFunction(vm, raylib, "GetGlyphInfo",   _GetGlyphInfo, 2, "Get glyph font info data for a codepoint (unicode character), fallback to '?' if not found");
  pkModuleAddFunction(vm, raylib, "GetGlyphAtlasRec",   _GetGlyphAtlasRec, 2, "Get glyph rectangle in font atlas for a codepoint (unicode character), fallback to '?' if not found");
  pkModuleAddFunction(vm, raylib, "GetCodepointCount",   _GetCodepointCount, 1, "Get total number of codepoints in a UTF-8 encoded string");
  pkModuleAddFunction(vm, raylib, "TextIsEqual",   _TextIsEqual, 2, "Check if two text string are equal");
  pkModuleAddFunction(vm, raylib, "TextLength",   _TextLength, 1, "Get text length, checks for '\0' ending");
  pkModuleAddFunction(vm, raylib, "TextSubtext",   _TextSubtext, 3, "Get a piece of a text string");
  pkModuleAddFunction(vm, raylib, "TextFindIndex",   _TextFindIndex, 2, "Find first text occurrence within a string");
  pkModuleAddFunction(vm, raylib, "TextToUpper",   _TextToUpper, 1, "Get upper case version of provided string");
  pkModuleAddFunction(vm, raylib, "TextToLower",   _TextToLower, 1, "Get lower case version of provided string");
  pkModuleAddFunction(vm, raylib, "TextToPascal",   _TextToPascal, 1, "Get Pascal case notation version of provided string");
  pkModuleAddFunction(vm, raylib, "TextToInteger",   _TextToInteger, 1, "Get integer value from text (negative values not supported)");
  pkModuleAddFunction(vm, raylib, "DrawLine3D",   _DrawLine3D, 3, "Draw a line in 3D world space");
  pkModuleAddFunction(vm, raylib, "DrawPoint3D",   _DrawPoint3D, 2, "Draw a point in 3D space, actually a small line");
  pkModuleAddFunction(vm, raylib, "DrawCircle3D",   _DrawCircle3D, 5, "Draw a circle in 3D world space");
  pkModuleAddFunction(vm, raylib, "DrawTriangle3D",   _DrawTriangle3D, 4, "Draw a color-filled triangle (vertex in counter-clockwise order!)");
  pkModuleAddFunction(vm, raylib, "DrawTriangleStrip3D",   _DrawTriangleStrip3D, 3, "Draw a triangle strip defined by points");
  pkModuleAddFunction(vm, raylib, "DrawCube",   _DrawCube, 5, "Draw cube");
  pkModuleAddFunction(vm, raylib, "DrawCubeV",   _DrawCubeV, 3, "Draw cube (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawCubeWires",   _DrawCubeWires, 5, "Draw cube wires");
  pkModuleAddFunction(vm, raylib, "DrawCubeWiresV",   _DrawCubeWiresV, 3, "Draw cube wires (Vector version)");
  pkModuleAddFunction(vm, raylib, "DrawCubeTexture",   _DrawCubeTexture, 6, "Draw cube textured");
  pkModuleAddFunction(vm, raylib, "DrawCubeTextureRec",   _DrawCubeTextureRec, 7, "Draw cube with a region of a texture");
  pkModuleAddFunction(vm, raylib, "DrawSphere",   _DrawSphere, 3, "Draw sphere");
  pkModuleAddFunction(vm, raylib, "DrawSphereEx",   _DrawSphereEx, 5, "Draw sphere with extended parameters");
  pkModuleAddFunction(vm, raylib, "DrawSphereWires",   _DrawSphereWires, 5, "Draw sphere wires");
  pkModuleAddFunction(vm, raylib, "DrawCylinder",   _DrawCylinder, 6, "Draw a cylinder/cone");
  pkModuleAddFunction(vm, raylib, "DrawCylinderEx",   _DrawCylinderEx, 6, "Draw a cylinder with base at startPos and top at endPos");
  pkModuleAddFunction(vm, raylib, "DrawCylinderWires",   _DrawCylinderWires, 6, "Draw a cylinder/cone wires");
  pkModuleAddFunction(vm, raylib, "DrawCylinderWiresEx",   _DrawCylinderWiresEx, 6, "Draw a cylinder wires with base at startPos and top at endPos");
  pkModuleAddFunction(vm, raylib, "DrawPlane",   _DrawPlane, 3, "Draw a plane XZ");
  pkModuleAddFunction(vm, raylib, "DrawRay",   _DrawRay, 2, "Draw a ray line");
  pkModuleAddFunction(vm, raylib, "DrawGrid",   _DrawGrid, 2, "Draw a grid (centered at (0, 0, 0))");
  pkModuleAddFunction(vm, raylib, "LoadModel",   _LoadModel, 1, "Load model from files (meshes and materials)");
  pkModuleAddFunction(vm, raylib, "LoadModelFromMesh",   _LoadModelFromMesh, 1, "Load model from generated mesh (default material)");
  pkModuleAddFunction(vm, raylib, "UnloadModel",   _UnloadModel, 1, "Unload model (including meshes) from memory (RAM and/or VRAM)");
  pkModuleAddFunction(vm, raylib, "UnloadModelKeepMeshes",   _UnloadModelKeepMeshes, 1, "Unload model (but not meshes) from memory (RAM and/or VRAM)");
  pkModuleAddFunction(vm, raylib, "GetModelBoundingBox",   _GetModelBoundingBox, 1, "Compute model bounding box limits (considers all meshes)");
  pkModuleAddFunction(vm, raylib, "DrawModel",   _DrawModel, 4, "Draw a model (with texture if set)");
  pkModuleAddFunction(vm, raylib, "DrawModelEx",   _DrawModelEx, 6, "Draw a model with extended parameters");
  pkModuleAddFunction(vm, raylib, "DrawModelWires",   _DrawModelWires, 4, "Draw a model wires (with texture if set)");
  pkModuleAddFunction(vm, raylib, "DrawModelWiresEx",   _DrawModelWiresEx, 6, "Draw a model wires (with texture if set) with extended parameters");
  pkModuleAddFunction(vm, raylib, "DrawBoundingBox",   _DrawBoundingBox, 2, "Draw bounding box (wires)");
  pkModuleAddFunction(vm, raylib, "DrawBillboard",   _DrawBillboard, 5, "Draw a billboard texture");
  pkModuleAddFunction(vm, raylib, "DrawBillboardRec",   _DrawBillboardRec, 6, "Draw a billboard texture defined by source");
  pkModuleAddFunction(vm, raylib, "DrawBillboardPro",   _DrawBillboardPro, 9, "Draw a billboard texture defined by source and rotation");
  pkModuleAddFunction(vm, raylib, "UploadMesh",   _UploadMesh, 2, "Upload mesh vertex data in GPU and provide VAO/VBO ids");
  pkModuleAddFunction(vm, raylib, "UnloadMesh",   _UnloadMesh, 1, "Unload mesh data from CPU and GPU");
  pkModuleAddFunction(vm, raylib, "DrawMesh",   _DrawMesh, 3, "Draw a 3d mesh with material and transform");
  pkModuleAddFunction(vm, raylib, "DrawMeshInstanced",   _DrawMeshInstanced, 4, "Draw multiple mesh instances with material and different transforms");
  pkModuleAddFunction(vm, raylib, "ExportMesh",   _ExportMesh, 2, "Export mesh data to file, returns true on success");
  pkModuleAddFunction(vm, raylib, "GetMeshBoundingBox",   _GetMeshBoundingBox, 1, "Compute mesh bounding box limits");
  pkModuleAddFunction(vm, raylib, "GenMeshTangents",   _GenMeshTangents, 1, "Compute mesh tangents");
  pkModuleAddFunction(vm, raylib, "GenMeshBinormals",   _GenMeshBinormals, 1, "Compute mesh binormals");
  pkModuleAddFunction(vm, raylib, "GenMeshPoly",   _GenMeshPoly, 2, "Generate polygonal mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshPlane",   _GenMeshPlane, 4, "Generate plane mesh (with subdivisions)");
  pkModuleAddFunction(vm, raylib, "GenMeshCube",   _GenMeshCube, 3, "Generate cuboid mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshSphere",   _GenMeshSphere, 3, "Generate sphere mesh (standard sphere)");
  pkModuleAddFunction(vm, raylib, "GenMeshHemiSphere",   _GenMeshHemiSphere, 3, "Generate half-sphere mesh (no bottom cap)");
  pkModuleAddFunction(vm, raylib, "GenMeshCylinder",   _GenMeshCylinder, 3, "Generate cylinder mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshCone",   _GenMeshCone, 3, "Generate cone/pyramid mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshTorus",   _GenMeshTorus, 4, "Generate torus mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshKnot",   _GenMeshKnot, 4, "Generate trefoil knot mesh");
  pkModuleAddFunction(vm, raylib, "GenMeshHeightmap",   _GenMeshHeightmap, 2, "Generate heightmap mesh from image data");
  pkModuleAddFunction(vm, raylib, "GenMeshCubicmap",   _GenMeshCubicmap, 2, "Generate cubes-based map mesh from image data");
  pkModuleAddFunction(vm, raylib, "LoadMaterialDefault",   _LoadMaterialDefault, 0, "Load default material (Supports: DIFFUSE, SPECULAR, NORMAL maps)");
  pkModuleAddFunction(vm, raylib, "UnloadMaterial",   _UnloadMaterial, 1, "Unload material from GPU memory (VRAM)");
  pkModuleAddFunction(vm, raylib, "SetMaterialTexture",   _SetMaterialTexture, 3, "Set texture for a material map type (MATERIAL_MAP_DIFFUSE, MATERIAL_MAP_SPECULAR...)");
  pkModuleAddFunction(vm, raylib, "SetModelMeshMaterial",   _SetModelMeshMaterial, 3, "Set material for a mesh");
  pkModuleAddFunction(vm, raylib, "UpdateModelAnimation",   _UpdateModelAnimation, 3, "Update model animation pose");
  pkModuleAddFunction(vm, raylib, "UnloadModelAnimation",   _UnloadModelAnimation, 1, "Unload animation data");
  pkModuleAddFunction(vm, raylib, "UnloadModelAnimations",   _UnloadModelAnimations, 2, "Unload animation array data");
  pkModuleAddFunction(vm, raylib, "IsModelAnimationValid",   _IsModelAnimationValid, 2, "Check model animation skeleton match");
  pkModuleAddFunction(vm, raylib, "CheckCollisionSpheres",   _CheckCollisionSpheres, 4, "Check collision between two spheres");
  pkModuleAddFunction(vm, raylib, "CheckCollisionBoxes",   _CheckCollisionBoxes, 2, "Check collision between two bounding boxes");
  pkModuleAddFunction(vm, raylib, "CheckCollisionBoxSphere",   _CheckCollisionBoxSphere, 3, "Check collision between box and sphere");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionSphere",   _GetRayCollisionSphere, 3, "Get collision info between ray and sphere");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionBox",   _GetRayCollisionBox, 2, "Get collision info between ray and box");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionModel",   _GetRayCollisionModel, 2, "Get collision info between ray and model");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionMesh",   _GetRayCollisionMesh, 3, "Get collision info between ray and mesh");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionTriangle",   _GetRayCollisionTriangle, 4, "Get collision info between ray and triangle");
  pkModuleAddFunction(vm, raylib, "GetRayCollisionQuad",   _GetRayCollisionQuad, 5, "Get collision info between ray and quad");
  pkModuleAddFunction(vm, raylib, "InitAudioDevice",   _InitAudioDevice, 0, "Initialize audio device and context");
  pkModuleAddFunction(vm, raylib, "CloseAudioDevice",   _CloseAudioDevice, 0, "Close the audio device and context");
  pkModuleAddFunction(vm, raylib, "IsAudioDeviceReady",   _IsAudioDeviceReady, 0, "Check if audio device has been initialized successfully");
  pkModuleAddFunction(vm, raylib, "SetMasterVolume",   _SetMasterVolume, 1, "Set master volume (listener)");
  pkModuleAddFunction(vm, raylib, "LoadWave",   _LoadWave, 1, "Load wave data from file");
  pkModuleAddFunction(vm, raylib, "LoadSound",   _LoadSound, 1, "Load sound from file");
  pkModuleAddFunction(vm, raylib, "LoadSoundFromWave",   _LoadSoundFromWave, 1, "Load sound from wave data");
  pkModuleAddFunction(vm, raylib, "UnloadWave",   _UnloadWave, 1, "Unload wave data");
  pkModuleAddFunction(vm, raylib, "UnloadSound",   _UnloadSound, 1, "Unload sound");
  pkModuleAddFunction(vm, raylib, "ExportWave",   _ExportWave, 2, "Export wave data to file, returns true on success");
  pkModuleAddFunction(vm, raylib, "ExportWaveAsCode",   _ExportWaveAsCode, 2, "Export wave sample data to code (.h), returns true on success");
  pkModuleAddFunction(vm, raylib, "PlaySound",   _PlaySound, 1, "Play a sound");
  pkModuleAddFunction(vm, raylib, "StopSound",   _StopSound, 1, "Stop playing a sound");
  pkModuleAddFunction(vm, raylib, "PauseSound",   _PauseSound, 1, "Pause a sound");
  pkModuleAddFunction(vm, raylib, "ResumeSound",   _ResumeSound, 1, "Resume a paused sound");
  pkModuleAddFunction(vm, raylib, "PlaySoundMulti",   _PlaySoundMulti, 1, "Play a sound (using multichannel buffer pool)");
  pkModuleAddFunction(vm, raylib, "StopSoundMulti",   _StopSoundMulti, 0, "Stop any sound playing (using multichannel buffer pool)");
  pkModuleAddFunction(vm, raylib, "GetSoundsPlaying",   _GetSoundsPlaying, 0, "Get number of sounds playing in the multichannel");
  pkModuleAddFunction(vm, raylib, "IsSoundPlaying",   _IsSoundPlaying, 1, "Check if a sound is currently playing");
  pkModuleAddFunction(vm, raylib, "SetSoundVolume",   _SetSoundVolume, 2, "Set volume for a sound (1.0 is max level)");
  pkModuleAddFunction(vm, raylib, "SetSoundPitch",   _SetSoundPitch, 2, "Set pitch for a sound (1.0 is base level)");
  pkModuleAddFunction(vm, raylib, "WaveFormat",   _WaveFormat, 4, "Convert wave data to desired format");
  pkModuleAddFunction(vm, raylib, "WaveCopy",   _WaveCopy, 1, "Copy a wave to a new wave");
  pkModuleAddFunction(vm, raylib, "WaveCrop",   _WaveCrop, 3, "Crop a wave to defined samples range");
  pkModuleAddFunction(vm, raylib, "LoadMusicStream",   _LoadMusicStream, 1, "Load music stream from file");
  pkModuleAddFunction(vm, raylib, "UnloadMusicStream",   _UnloadMusicStream, 1, "Unload music stream");
  pkModuleAddFunction(vm, raylib, "PlayMusicStream",   _PlayMusicStream, 1, "Start music playing");
  pkModuleAddFunction(vm, raylib, "IsMusicStreamPlaying",   _IsMusicStreamPlaying, 1, "Check if music is playing");
  pkModuleAddFunction(vm, raylib, "UpdateMusicStream",   _UpdateMusicStream, 1, "Updates buffers for music streaming");
  pkModuleAddFunction(vm, raylib, "StopMusicStream",   _StopMusicStream, 1, "Stop music playing");
  pkModuleAddFunction(vm, raylib, "PauseMusicStream",   _PauseMusicStream, 1, "Pause music playing");
  pkModuleAddFunction(vm, raylib, "ResumeMusicStream",   _ResumeMusicStream, 1, "Resume playing paused music");
  pkModuleAddFunction(vm, raylib, "SeekMusicStream",   _SeekMusicStream, 2, "Seek music to a position (in seconds)");
  pkModuleAddFunction(vm, raylib, "SetMusicVolume",   _SetMusicVolume, 2, "Set volume for music (1.0 is max level)");
  pkModuleAddFunction(vm, raylib, "SetMusicPitch",   _SetMusicPitch, 2, "Set pitch for a music (1.0 is base level)");
  pkModuleAddFunction(vm, raylib, "GetMusicTimeLength",   _GetMusicTimeLength, 1, "Get music time length (in seconds)");
  pkModuleAddFunction(vm, raylib, "GetMusicTimePlayed",   _GetMusicTimePlayed, 1, "Get current music time played (in seconds)");
  pkModuleAddFunction(vm, raylib, "LoadAudioStream",   _LoadAudioStream, 3, "Load audio stream (to stream raw audio pcm data)");
  pkModuleAddFunction(vm, raylib, "UnloadAudioStream",   _UnloadAudioStream, 1, "Unload audio stream and free memory");
  pkModuleAddFunction(vm, raylib, "IsAudioStreamProcessed",   _IsAudioStreamProcessed, 1, "Check if any audio stream buffers requires refill");
  pkModuleAddFunction(vm, raylib, "PlayAudioStream",   _PlayAudioStream, 1, "Play audio stream");
  pkModuleAddFunction(vm, raylib, "PauseAudioStream",   _PauseAudioStream, 1, "Pause audio stream");
  pkModuleAddFunction(vm, raylib, "ResumeAudioStream",   _ResumeAudioStream, 1, "Resume audio stream");
  pkModuleAddFunction(vm, raylib, "IsAudioStreamPlaying",   _IsAudioStreamPlaying, 1, "Check if audio stream is playing");
  pkModuleAddFunction(vm, raylib, "StopAudioStream",   _StopAudioStream, 1, "Stop audio stream");
  pkModuleAddFunction(vm, raylib, "SetAudioStreamVolume",   _SetAudioStreamVolume, 2, "Set volume for audio stream (1.0 is max level)");
  pkModuleAddFunction(vm, raylib, "SetAudioStreamPitch",   _SetAudioStreamPitch, 2, "Set pitch for audio stream (1.0 is base level)");
  pkModuleAddFunction(vm, raylib, "SetAudioStreamBufferSizeDefault",   _SetAudioStreamBufferSizeDefault, 1, "Default size for new audio streams");
